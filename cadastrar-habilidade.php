<?php
  ...
  // pra usar esses dados tem um input no final do formulário (l.115)
?>
...
<div class="container-fluid bg1 text-center" id="quem">
  ...
  <h3>Cadastro de Habilidade</h3>
  
  <form action="acoes/cria-habilidade.php" method="POST" class="needs-validation container" novalidate>

    <div class="row g-12">

      <div class="col-sm-12">
        <label for="nome_habilidade" class="form-label">Habilidade</label>
        <input type="text" class="form-control" id="nome_habilidade" name="nome_habilidade" placeholder="" value="" required>
