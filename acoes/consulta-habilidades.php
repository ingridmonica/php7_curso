...
// EDITAR E REVISAR DPS
    ...
    <li class='list-group-item'>
      ...
      <a href='apaga-curso.php?id={$idhabilidade}' data-bs-toggle='modal' data-bs-target='#exampleModal{$idcurso}'><i class='bi bi-trash'></i></a>
      $idcurso - $nome_curso - $instituicao - $ano_curso
    </li>
    <!-- modal OBS mudar o numero no id para ficar igual id no banco de dados -->
    <div class='modal fade' id='exampleModal{$idhabilidade}' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
      <div class='modal-dialog'>
        <div class='modal-content'>
          ...
          <div class='modal-body'>
            Deseja apagar a habilidade {$idhabilidade} ?
          </div>
          <div class='modal-footer'>
            <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Cancelar</button>
            
            <form action='acoes/apaga-curso.php' method='POST'>
              <input type='hidden' name='idcurso' value='{$idhabilidade}'>
