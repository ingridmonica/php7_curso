  ...
  <form action="acoes/edita-senha.php" method="POST" class="needs-validation container" name="formuser" novalidate>
    ...
    <div class="row g-12">
      ...
      <div class="col-sm-12">
        ...
        <input type="password" class="form-control" id="conf_senha" name="conf_senha" placeholder="" value="" required 
        onBlur="return validarSenhas()">
        <!-- Função do JS 'validarSenhas()' através do método 'onBlur'. Após sair da confirmação da senha, ele faz essa verificação  -->
        <div class="invalid-feedback">
          Digite a senha anterior
        </div>
          <br>
        <button class="w-100 btn btn-dark btn-lg" type="submit" name="bt_editar">
          Editar
        </button>
      </div>
